package com.github.matin2.mcore.services.search

import com.github.matin2.mcore.PacketEventsHook
import com.github.matin2.mcore.services.PacketService.sendPacket
...
internal class SearchMenuService(packetEvents: PacketEventsHook) : PacketListenerAbstract(NORMAL) {
	...
	init {
		packetEvents.api?.eventManager?.registerListener(this)
	}
